...
func (api *API) GetCurrentMedianHistoryPrice() (*CurrentMedianHistoryPrice, error) {
	...
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrapf(err, "%v: failed to unmarshal get_current_median_history_price response", apiID)
	}
	return &resp, nil
}
...
func (api *API) GetFeedHistory() (*FeedHistory, error) {
	...
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrapf(err, "%v: failed to unmarshal get_feed_history response", apiID)
	}
	return &resp, nil
}
...
func (api *API) GetMinerQueue() ([]*string, error) {
	...
	var resp []*string
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrapf(err, "%v: failed to unmarshal get_miner_queue response", apiID)
	}
	return resp, nil
}
...
func (api *API) GetWitnessByAccount(author string) (*Witness, error) {
	...
	var resp Witness
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrapf(err, "%v: failed to unmarshal get_witness_by_account response", apiID)
	}
	return &resp, nil
}
...
func (api *API) GetWitnessCount() (*uint32, error) {
	...
	var resp uint32
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrapf(err, "%v: failed to unmarshal get_witness_count response", apiID)
	}
	return &resp, nil
}
...
func (api *API) GetWitnessSchedule() (*WitnessSchedule, error) {
	...
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrapf(err, "%v: failed to unmarshal get_witness_schedule response", apiID)
	}
	return &resp, nil
}
...
func (api *API) GetWitnesses(id []uint32) ([]*Witness, error) {
	...
	var resp []*Witness
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrapf(err, "%v: failed to unmarshal get_witnesses response", apiID)
	}
	return resp, nil
}
...
func (api *API) GetWitnessByVote(author string, limit uint) ([]*Witness, error) {
	if limit > 1000 {
		return nil, errors.Errorf("%v: get_witnesses_by_vote -> limit must not exceed 1000", apiID)
	}
	...
	var resp []*Witness
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrapf(err, "%v: failed to unmarshal get_witnesses_by_vote response", apiID)
	}
	return resp, nil
}
...
func (api *API) LookupWitnessAccounts(author string, limit uint) ([]string, error) {
	if limit > 1000 {
		return nil, errors.Errorf("%v: lookup_witness_accounts -> limit must not exceed 1000", apiID)
	}
	...
	var resp []string
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrapf(err, "%v: failed to unmarshal lookup_witness_accounts response", apiID)
	}
	return resp, nil
}
